    ...
    <div className="bg-gray-900 border-b border-gray-800 px-8 py-4 flex justify-between items-center">
      ...
      <div className="flex gap-8 items-center">
        ...
        <div className="relative">
          ...
          {open && (
            <div className="absolute top-8 bg-gray-800 rounded-xl shadow-lg p-3 space-y-2 w-48">
              <Link to="/admin/crops" className="block hover:text-emerald-400">
                Crop Details
              </Link>
              <Link to="/admin/crops?tab=dataset" className="block hover:text-emerald-400">
                Dataset Manager
              </Link>
            </div>
          )}
